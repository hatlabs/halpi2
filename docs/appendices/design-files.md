...
A patch release addressing signal integrity and grounding improvements discovered during production testing.

Changes:

- Add a clock oscillator for NVMe SUSCLK to fix compatibility issues with certain NVMe SSDs
- Add missing capacitors to USB3 hub RX differential pairs
- Provide grounding at every mounting point

### Design Files

- KiCad design files: [https://github.com/hatlabs/HALPI2-hardware/archive/refs/tags/v0.6.1.zip](https://github.com/hatlabs/HALPI2-hardware/archive/refs/tags/v0.6.1.zip)
- Schematic PDF: [HALPI2-schematic_v0.6.1.pdf](./HALPI2-schematic_v0.6.1.pdf)
...
- Improve 10V buck converter stability — no longer whines under any circumstances
...
The first public release of HALPI2.
